...
# ----------------------------------------------------------------------------
print(df.describe())
# This plots histograms for X, Y, and Z coordinates to understand their distributions
...
# Step 3
# ----------------------------------------------------------------------------
# This calculates the correlation matrix between the coordinates (X, Y, Z) and the target variable (Step)
...
# This creates the confusion matrix for the best-performing model
